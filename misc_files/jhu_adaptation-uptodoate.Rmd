...
states.counties.hist.pull <- read_csv(paste0("states_counties_hist_",yesterday,".csv")) %>% 
...
if (!(yesterday %in% states.counties.hist.pull$date)) {
  ...
  fwrite(states.counties.hist, paste0("states_counties_hist_",yesterday,".csv"))
} else {
  states.counties.hist <- states.counties.hist.pull
}
...
```{r}
# state level data --------------------------------------------------------------
states.track.hist <- read_csv("states_track_hist.csv")
